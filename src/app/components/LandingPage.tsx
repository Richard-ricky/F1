...
// Real news from live search — Canadian GP weekend, May 22–23 2026
const NEWS: NewsItem[] = [
  {
    tag:"FP1 RESULT",
    headline:"Antonelli leads Russell in disrupted Canadian GP practice",
    body:"Mercedes dominated the only practice session at Montreal. Three red flags — Lawson car failure, Albon hitting a groundhog, Ocon spinning — extended the hour-long session. Antonelli's 1:13.402 left him a tenth clear of Russell, with Hamilton 0.7s back.",
    time:"22 May · 2h ago",
    source:"Formula1.com",
    url:"https://www.formula1.com/en/latest/article/fp1-antonelli-leads-russell-as-mercedes-dominate-disrupted-canadian-gp-practice-session.52B0jh2hwB6deh2lcWmGt5",
  },
  {
    tag:"TITLE FIGHT",
    headline:"Antonelli holds 20-point lead heading into Sprint weekend",
    body:"The 19-year-old Italian leads team-mate Russell after three consecutive victories in China, Japan and Miami. Russell won Canada last year and arrives with a major upgrade package, setting up a pivotal weekend.",
    time:"22 May · 3h ago",
  ...
  {
    tag:"UPGRADES",
    headline:"Mercedes unwrap first major upgrade of the 2026 season",
    body:"Mercedes have brought a substantial aero package to Montreal. McLaren also arrives with new developments after closing the gap significantly in Miami, where Norris pushed Antonelli hard for victory.",
    time:"22 May · 4h ago",
    source:"The Race",
    url:"https://www.the-race.com/formula-1/canadian-grand-prix-f1-practice-results-2026/",
  },
  {
    tag:"INCIDENT",
    headline:"Albon crashes after hitting groundhog — causes red flag",
    body:"Williams driver Alex Albon struck a groundhog on track during FP1, causing damage to his front wing and triggering the second of three red flags in an already chaotic session at Circuit Gilles Villeneuve.",
    time:"22 May · 5h ago",
    source:"GPFans",
    url:"https://www.gpfans.com/en/f1-news/1084131/f1-2026-canada-grand-prix-weather-forecast-latest-from-montreal/",
  },
  {
    tag:"WEATHER",
    headline:"Dry and sunny for Friday — rain risk grows Saturday",
    body:"FP1 and Sprint Qualifying on Friday benefit from dry conditions with sunny spells and 17°C temperatures. A weather front moves in overnight, with a small rain risk for Saturday qualifying threatening to shake up the grid.",
    time:"22 May · 6h ago",
    source:"GPFans",
    url:"https://www.gpfans.com/en/f1-news/1084131/f1-2026-canada-grand-prix-weather-forecast-latest-from-montreal/",
  },
  {
    tag:"SCHEDULE",
    headline:"Race pushed to 4pm local to avoid Indy 500 clash",
    body:"Sunday's Canadian Grand Prix start time has been moved to 4:00 pm local (9:00 pm BST) to minimise overlap with the Indianapolis 500, which runs on the same day — a nod to motorsport's historic triple crown tradition.",
    time:"21 May · 1d ago",
    source:"ESPN",
    ...
    <div style={{
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @keyframes news-ticker { 0%{transform:translateX(0)} 100%{transform:translateX(-50%)} }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontFamily:"'Oswald',sans-serif", fontWeight:700, fontSize:22, letterSpacing:"-0.02em" }}>
        ...
        <div style={{
          ...
          borderLeft:"1px solid rgba(255,255,255,0.06)", paddingLeft:24,
        }}>
          <div style={{ width:6, height:6, borderRadius:"50%", background:"#22c55e", animation:"live-pulse 1.5s ease-in-out infinite" }}/>
          <span style={{ fontFamily:"'DM Mono',monospace", fontSize:10, color:"rgba(255,255,255,0.4)", letterSpacing:"0.1em" }}>LIVE DATA</span>
        </div>
      </div>

      {/* ── MAIN 3-COLUMN GRID (fills remaining height minus bottom strip) ── */}
      <div style={{
        flex:1, minHeight:0,
        ...
        <div style={{
          ...
          {/* Scrollable inner so content never clips */}
          <div style={{ flex:1, overflowY:"auto", padding:"10px 32px 16px", display:"flex", flexDirection:"column", gap:0 }}>
            ...
            >
              <div style={{ fontFamily:"'Oswald',sans-serif", fontSize:"clamp(52px,6vw,88px)", fontWeight:700, lineHeight:0.85, letterSpacing:"-0.03em", textTransform:"uppercase", color:"#fff" }}>
                {next.name}
              </div>
              <div style={{ fontFamily:"'Oswald',sans-serif", fontSize:"clamp(52px,6vw,88px)", fontWeight:200, lineHeight:0.85, letterSpacing:"-0.03em", textTransform:"uppercase", color:"rgba(255,255,255,0.1)", WebkitTextStroke:"1px rgba(255,255,255,0.12)" }}>
                GRAND PRIX
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.5 }}
              style={{ marginTop:20, paddingTop:16, borderTop:"1px solid rgba(255,255,255,0.07)", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"8px 0" }}
            >
              {[
                ...
                {[{v:cd.d,l:"D"},{v:cd.h,l:"H"},{v:cd.m,l:"M"},{v:cd.s,l:"S"}].map((item, i) => (
                  <div key={item.l} style={{ display:"flex", alignItems:"baseline" }}>
                    ...
                    <div style={{ display:"flex", alignItems:"baseline", gap:3 }}>
                      ...
                      <span style={{ fontFamily:"'DM Mono',monospace", fontSize:8, color:"rgba(255,255,255,0.2)", letterSpacing:"0.1em" }}>{item.l}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.8 }}
              style={{ marginTop:20, display:"flex", gap:16, alignItems:"center" }}
            >
              <motion.button
                ...
                style={{
                  ...
                  fontFamily:"'Oswald',sans-serif", fontSize:12, fontWeight:400,
              ...
              <div style={{ display:"flex", gap:0 }}>
                {WDC.map((d, i) => (
                  <div key={d.code} style={{
                    ...
                    <div style={{ fontFamily:"'Oswald',sans-serif", fontSize:18, fontWeight:600, color:"#fff", letterSpacing:"0.04em" }}>{d.code}</div>
        ...
        >
          ...
          {/* Col headers */}
          <div style={{
            display:"grid", gridTemplateColumns:"28px 36px 56px 1fr 70px 70px 70px 20px",
            gap:0, padding:"8px 24px", borderBottom:"1px solid rgba(255,255,255,0.04)", flexShrink:0,
          }}>
          ...
          <div style={{ flex:1, overflowY:"auto" }}>
            {TIMING.map((row, i) => (
              <motion.div
                ...
                style={{
                  display:"grid", gridTemplateColumns:"28px 36px 56px 1fr 70px 70px 70px 20px",
                  alignItems:"center", gap:0, padding:"0 24px", height:38,
              ...
              >
                ...
                <span style={{ fontFamily:"'DM Mono',monospace", fontSize:8, textAlign:"right", color: row.tyre==="M"?"#FFD700":row.tyre==="H"?"#ccc":"#E8002D", fontWeight:500 }}>{row.tyre}</span>
              </motion.div>
            ))}
          </div>
            ...
            {NEWS.map((item, i) => (
              <motion.div
                ...
                style={{
                  ...
                  cursor:"pointer",
                  borderLeft: activeNews===i ? "2px solid #E8002D" : "2px solid transparent",
                  background: activeNews===i ? "rgba(232,0,45,0.04)" : "transparent",
                  transition:"all 0.15s",
                }}
                onMouseEnter={() => setActiveNews(i)}
                onMouseLeave={() => setActiveNews(-1)}
              >
                {/* Tag + time */}
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:6 }}>
                  <span style={{
                    fontFamily:"'DM Mono',monospace", fontSize:7, fontWeight:500,
                    letterSpacing:"0.16em", color:"#E8002D",
                ...
                {/* Headline */}
                <div style={{ fontFamily:"'Oswald',sans-serif", fontSize:13, fontWeight:500, color:"#fff", lineHeight:1.25, marginBottom:6, letterSpacing:"0.01em" }}>
                  {item.headline}
                </div>

                {/* Body */}
                <div style={{ fontFamily:"'DM Mono',monospace", fontSize:8.5, color:"rgba(255,255,255,0.35)", lineHeight:1.6 }}>
                  {item.body}
                </div>

                {/* Source */}
                <div style={{ marginTop:7, fontFamily:"'DM Mono',monospace", fontSize:7.5, color:"rgba(255,255,255,0.2)", display:"flex", alignItems:"center", gap:5 }}>
      ...
      {/* ── BOTTOM: Season strip (fixed height) ── */}
      <div style={{
        height:48, flexShrink:0,
          ...
          {RACES.map(race => {
            ...
            return (
              <div key={race.round} style={{
                ...
                flexShrink:0, minWidth: isNext ? 80 : 52, padding:"0 6px",
                borderRight:"1px solid rgba(255,255,255,0.04)",
                background: isNext ? "rgba(232,0,45,0.08)" : "transparent",
                borderTop: isNext ? "2px solid #E8002D" : "2px solid transparent",
              }}>
                <div style={{ fontFamily:"'DM Mono',monospace", fontSize:7, letterSpacing:"0.1em", marginBottom:1, color: isNext ? "#E8002D" : race.done ? "rgba(255,255,255,0.12)" : "rgba(255,255,255,0.25)" }}>
                  {isNext ? "NEXT" : `R${race.round}`}
                </div>
                <div style={{ fontFamily:"'Oswald',sans-serif", fontSize:11, fontWeight:500, color: isNext ? "#fff" : race.done ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.5)" }}>
                  {race.short}
                </div>
